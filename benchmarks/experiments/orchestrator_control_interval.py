    ...
    for workload_name, workload in workloads.items():
        for interval in intervals:
            for thread in threads:
                ...
                name = f"holpaca_{setup_type_name}_{workload_name}_{interval}_{thread}"
                setups[name] = Setup(
                    name,
...
EXPERIMENT = Experiment(
    name="orchestrator_control_interval",
    setups=setups,
